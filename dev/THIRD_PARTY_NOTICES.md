...
| Component | Version | License | Corresponding source |
| --- | --- | --- | --- |
| Codex | 0.156.1 | Apache-2.0 and third-party notices | <https://github.com/openai/codex/tree/rust-v0.156.1> | <!-- renovate: datasource=npm depName=@openai/codex -->
| Grok Build | 1.0.41 | Apache-2.0 and third-party notices | <https://github.com/xai-org/grok-build> | <!-- renovate: datasource=npm depName=@xai-official/grok -->
