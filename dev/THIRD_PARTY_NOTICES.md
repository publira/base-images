...
| pnpm | 12.4.2 | MIT | <https://github.com/pnpm/pnpm/tree/v12.4.2> | <!-- renovate: datasource=npm depName=pnpm -->
...
| Grok Build | 1.0.34 | Apache-2.0 and third-party notices | <https://github.com/xai-org/grok-build> | <!-- renovate: datasource=npm depName=@xai-official/grok -->
