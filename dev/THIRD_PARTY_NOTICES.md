...
| pnpm | 12.3.2 | MIT | <https://github.com/pnpm/pnpm/tree/v12.3.2> |

## AI agent CLIs

| Component | Version | License | Corresponding source |
| --- | --- | --- | --- |
| Codex | 0.153.2 | Apache-2.0 and third-party notices | <https://github.com/openai/codex/tree/rust-v0.153.2> |
